            ...
            <b-card
                ...
                <ul class="tomo-list list-unstyled">
                    <li class="tomo-list__item">
                        ...
                        <span class="tomo-list__text">You have to deposit at least 50,000 CLMP</span>
                    </li>
                    <li class="tomo-list__item">
                ...
                <b-form
                    ...
                    <b-form-group
                        :description="`How much CLMP do you want to deposit? TX fee: ${txFee} CLMP`"
                        label="Vote"
                        ...
                        <b-input-group>
                            ...
                            <span
                                ...
                                class="text-danger">Must be greater than 50,000 CLMP</span>
                        </b-input-group>
                    </b-form-group>
                    <b-form-group
            ...
            if (!this.$v.$invalid) {
                if (this.coinbase.toLowerCase() === this.account.toLowerCase()) {
                    ...
                    if (this.balance.isLessThan(convertedAmount)) {
                        this.$toasted.show(`Not enough CLMP`, {
                            type: 'error'
                        })
                        return false
                    }
