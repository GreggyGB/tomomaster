                        ...
                        <b-card
                            ...
                            <h4 class=" color-white tomo-card__title tomo-card__title--big">Unvote
                                <span
                                    ...
                                    Your CLMP will be locked in a duration after unvoting</span>
                            </h4>
                            ...
                            <b-form
                                ...
                                <b-form-group
                                    :description="`The amount of CLMP to unvote. TX fee: ${txFee} CLMP`"
                                    label="Amount"
                                    ...
                                    <b-input-group>
                                        ...
                                        <!-- <span
                                            v-else-if="isMin"
                                            class="text-danger">Minimum of unvoting is 100 CLMP </span> -->
                                        <span
                                            v-else-if="isMax"
                                            class="text-danger">
                                            Must be less than {{ limitedUnvote }} CLMP </span>
                                        <span
                                            v-else-if="!isEnoughTomo"
                                            class="text-danger">Voted amount left should not less than 100 CLMP </span>
                                    </b-input-group>
                                </b-form-group>
